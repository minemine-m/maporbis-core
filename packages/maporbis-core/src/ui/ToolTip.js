...
export class ToolTip extends UIComponent {
    ...
    addTo(owner) {
        ...
        if (this.options.coordinate) {
            this._standaloneCoord = [...this.options.coordinate];
        }
    ...
    setCoordinate(coordinate) {
        this._standaloneCoord = [...coordinate];
        if (this.isVisible()) {
            this.show(this._standaloneCoord);
        }
        return this;
     ...
     */
    getCoordinate() {
        return this._standaloneCoord ? [...this._standaloneCoord] : undefined;
    }
    /**
     * Set content.
     * 设置内容
    ...
    setContent(content) {
        ...
        const inner = dom.querySelector('.maporbis-tooltip');
        if (!inner) {
            return this;
        }
        inner.innerHTML = '';
