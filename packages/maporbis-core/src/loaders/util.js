 ...
 */
export function vector2ToWGS84(vector2, tileX, tileY, zoom, extent = TILE_EXTENT) {
    const { x, y } = vector2;
    // 标准化瓦片坐标到0-1范围 (全球范围)
 ...
 */
export function convertGeometryToWGS84(geometryData, tileX, tileY, zoom) {
    ...
    function convertCoordinates(coords) {
        ...
        if (typeof coords === 'object' && coords.x !== undefined && coords.y !== undefined) {
            ...
            return vector2ToWGS84(coords, tileX, tileY, zoom);
        }
        ...
        if (Array.isArray(coords) && coords.length > 0) {
            ...
            if (typeof firstItem === 'object' && firstItem.x !== undefined && firstItem.y !== undefined) {
                ...
                return coords.map((vector2) => vector2ToWGS84(vector2, tileX, tileY, zoom));
            }
            else {
                // 这是嵌套数组，继续递归
