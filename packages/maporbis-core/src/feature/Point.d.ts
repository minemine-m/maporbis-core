 ...
 * @category Feature
 */
export declare abstract class Point extends Feature {
    /**
     ...
     */
    protected _createRenderObject(): Points<BufferGeometry<import("three").NormalBufferAttributes, import("three").BufferGeometryEventMap>, PointsMaterial, import("three").Object3DEventMap>;
}
